...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-primary/90 hover:outline hover:outline-primary hover:bg-[#1f005e]",
        destructive:
        ...
        "btn-primary":
          "  whitespace-nowrap bg-primary text-md text-primary-foreground shadow-2xl shadow-indigo-600/50 hover:bg-[#3b00b2] rounded-lg",
        "btn-primary-grey":
